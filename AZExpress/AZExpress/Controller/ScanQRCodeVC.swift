...
class ScanQRCodeVC: BaseVC {
    ...
    func setupScan(){
        ...
        previewLayer.frame = vwImage.layer.bounds
        previewLayer.videoGravity = .resizeAspectFill
        vwImage.layer.addSublayer(previewLayer)
        vwImage.bringSubviewToFront(imvScan)
        vwImage.bringSubviewToFront(btnCapture)
...
//-MARK: Extension for AVCaptureSession
